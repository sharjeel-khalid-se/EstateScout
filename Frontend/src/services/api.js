...
const fallbackBaseUrl = 'https://estate-scout-backend.vercel.app/api';
const API_BASE_URL = (envBaseUrl || fallbackBaseUrl).replace('estate-scout-backedn', 'estate-scout-backend');
